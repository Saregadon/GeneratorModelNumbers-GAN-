...
def define_discriminator(in_shape=(28,28,1)):
	model = Sequential()
	model.add(Conv2D(64, (3,3), strides=(2, 2), padding='same', input_shape=in_shape)) #possible the issue?
...
def load_real_samples():
	...
	X = X.astype('float32')
	# scale from [0,255] to [-1,1] //DONE NOW INFUSE TANH
	X = ((X/255)*2)-1 #same thing as (X - 127.5) / 127.5
	return X
